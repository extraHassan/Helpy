...
public class Database {
	...
	private Database() {
        dataSource = new MySQLDatabase(DatabaseInfos.DATABASE);
        dataSource.setUser(DatabaseInfos.USER);
        dataSource.setPassword(DatabaseInfos.PASSWORD);
	...
	public int delete(String tableName, String columnName, Object value) {
		try {
            System.out.println("SQL QUERY  >>>  | "+"DELETE FROM " + tableName + " WHERE " + columnName + " = '" + value + "'");
            Statement sql = db.createStatement();
