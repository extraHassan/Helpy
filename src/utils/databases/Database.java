...
public class Database {
	...
	public String[][] executeQuery(String query){
		try {
			Statement sql = db.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, 
	...
	public int insert(String tableName, Object ...row) {
		StringBuffer sb = new StringBuffer("INSERT INTO "+delimit(tableName)
		+" VALUES('"+row[0]+"'");
	...
	/*
	 * suppose que le nom de la table est = au nom simple de la classe
	 * ou bien la class est annote par @Table a fin de sp�sifier le nom du la table
	 */
...
public void testSelect() {
	try {
		//moteur d'execution de requete "statement"
		Statement sql = db.createStatement();
